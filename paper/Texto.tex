...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\label{fig:TDR}
	\end{subfigure}
	\caption{(a) Total Horizontal \change{Gradient}{Derivative} (THDR) map of the gravitational field in the State of Paraná, values in microgals per meter ($\mu Gal/m$); (b) Tilt Derivative (TDR) map for the State of Paraná, representing the tilt derivative, values in radians.}
	\label{fig:subfigs}
\end{figure}
