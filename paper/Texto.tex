...
\usepackage{xcolor}
\definecolor{darkgreenhl}{RGB}{0,120,0} % verde escuro elegante

\newif\iffinalversion
\finalversiontrue   % <<< versão final
%\finalversionfalse % <<< versão com marcações
...
\else
    ...
    % ===== VERSÃO REVISÃO =====
    \newcommand{\added}[1]{\textcolor{darkgreenhl}{\textbf{#1}}}
...
\title{INTEGRATION OF GRAVITY DISTURBANCE AND BOUGUER DISTURBANCE FOR GEOLOGICAL AND GEOPHYSICAL MAPPING IN PARANÁ STATE, SOUTHERN BRAZIL}
...
\keywords{
    \change{Fatiando a Terra}{Gravity Database}; Bouguer Disturbance; Paranapanema Block; Paraná Basin; Ponta Grossa Arch
    }
%
\begin{document}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.75]{./Figures/mapa_geo_05fev2026.png}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.75]{./Figures/mapa_estru_05fev2026.png}
...
Topographic data from the global digital elevation model FABDEM \citep{Hawker2022fabdem}, integrated with bathymetry from SRTM15+ \citep{Tozer2019SRTM15Plus}, were used in the modeling of prisms, Figure \ref{fig:mde}. FABDEM was chosen because it is closer to a digital terrain model as it has undergone filtering of trees and buildings. Given the vast extent of the study area, the topographic data were resampled to a resolution of 500 meters. The density assigned to the prisms was defined based on the Lateral Topographic Density model for Brazil (\change{LTDBrasil}{LTD\_Brazil}) \citep{Medeiros2021densityBrazil}, by taking the arithmetic average of the model values for Paraná \(\rho = 2512 \hspace{5pt} kg/m^3\), Figure \ref{fig:ltdbrasil}. Finally, the \change{complet}{complete} \change{Bouguer disturbance}{Bouguer Disturbance} \(\delta g_B\) can be calculated as per Equation \ref{eq:prismas}.
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		...
		\label{fig:ltdbrasil}
	\end{subfigure}
	\caption{(a) Digital elevation model, adapted from \cite{Tozer2019SRTM15Plus} and \cite{Hawker2022fabdem}; (b) Lateral Topographic Density model for State of Paraná, adapted from \cite{Medeiros2021densityBrazil}.}
	\label{fig:subfigs}
\end{figure}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./Figures/ae_livre_zanon_05fev2026.png}
		\caption{}
		\label{fig:fr_zanon}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./Figures/bouguer_zanon_05fev2026.png}
		\caption{}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.65]{./Figures/mapa_estruBD_05fev2026.png}
...
\begin{figure}[h!]
	...
	\begin{subfigure}[b]{0.49\textwidth}
		\centering
		\includegraphics[width=0.95\textwidth]{./Figures/mapa_THDR_05fev2026.png}
		\caption{}
		\label{fig:THDR}
	\end{subfigure}
	\begin{subfigure}[b]{0.49\textwidth}
...
\begin{figure}[h!]
	\centering
	\includegraphics[scale=0.65]{./Figures/mapa_estruGHT_05fev2026.png}
...
\begin{figure}[h]
	\centering
	\includegraphics[scale=0.65]{./Figures/mapa_estruISA_05fev2026.png}
...
We thank the Laboratory of Applied Geophysics Research (LPGA)\added{, Federal University of Paraná (UFPR),} for the technical support and infrastructure provided for this work. We also thank the \change{Coordination for the Improvement of Higher Education Personnel}{Brazilian Federal Agency for Support and Evaluation of Graduate Education} (CAPES) for the master's scholarship funding, which enabled the development of this research.

F. J. F. Ferreira was supported in this research by the National Council for Scientific and Technological Development (CNPq\added{ -- Brazil}), under contract 308956/2022-2.

\section*{DATA AND MATERIALS AVAILABILITY}

\added{
The data, processing routines, and supporting materials used in this study are publicly available in a GitHub repository at: \url{https://github.com/ErosKerouak/GRAV_PR.git}.
}
...
%\bibliographystyle{plain} % or choose another style like 'apalike', 'ieeetr', etc.
